    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // UNCOMMENT METODS BELOW TO TEST
            ...
            //Read
            var capturedUser = db.GetUser(1008);
            ...
            // var UpdatedRow = db.UpdateUser(capturedUser,"kamssy@yaooo.com", "kamsyy");
             //var UpdatedJustEmnRow aili= db.UpdateUser(capturedUser, "kamssy@yaooo.com");
            //var UpdatedJustNameinRow = db.UpdateUser(capturedUser, "kamsyy");

            //Delete
            //NOTE TO TESTER :
            //Please wen tryin dis delete metod , make sure captured user has an Id within the range 1008 - 1047 
            //db.DeleteUser(capturedUser);

            //Transaction
            //NOTE TO TESTER :
            //This metod will delete any User passed to it
            //Please wen tryin dis Transaction metod , make sure captured user has an Id within the range 1008 - 1047 
